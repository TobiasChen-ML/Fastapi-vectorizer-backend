...
def build_order(user_id,amount,order_name = 'VectorizerCN-API-SERVICE',order_detail = "VectorizerCN-API-SERVICE"):
    ...
    if data_dict.get('return_code') == 'SUCCESS':
        ...
        output_url = os.getenv('DOMAIN_NAME') + f'/static/{qrcode_name}'
        ...
        p = create_payment(user_id, amount, order_id, currency="CNY", status="pending")
        return s
    s = {
        "code": 1001,
        "msg": "获取失败",
